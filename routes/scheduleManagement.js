...
router.get('/', (req,res) => {
        db.any('SELECT user_id, day, TO_CHAR(start_at,\'fmHH12:MI AM\') as start_at, TO_CHAR(end_at,\'fmHH12:MI AM\') as end_at * FROM schedules WHERE user_id=$1;', [req.session.id]) 
            .then((result) => {
