...
router.get('/', redirectToLogin, (req,res) => {
    db.any(`SELECT user_id, first_name, surname, day, TO_CHAR(start_at,\'fmHH12:MI AM\') as start_at, TO_CHAR(end_at,\'fmHH12:MI AM\') as end_at FROM schedules INNER JOIN users ON schedules.user_id=users.id WHERE user_id = $1;`, [req.session.userId])
            .then((result) => {
